...
module.exports = {
  ...
  userPrincipalName: process.env.NEXT_PUBLIC_USER_PRINCIPLE_NAME || 'Niko@nikodos.onmicrosoft.com',
  ...
  email: 'mailto:liuzx0636@outlook.com',
  ...
  links: [
    {
      name: 'GitHub',
      link: 'https://github.com/Niko-Karen',
    },
  ],
